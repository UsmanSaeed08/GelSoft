/* $Id: IPRScanClient.java 1816 2011-04-05 09:51:24Z hpm $
 * ======================================================================
...
public class IPRScanClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	protected void srvProxyConnect() throws ServiceException {
            System.out.println("srvProxyConnect");
	...
	public String[] getParams() throws ServiceException, RemoteException {
		...
		String[] retVal = null;
                System.out.println("Ensure the service proxy exists start");
		this.srvProxyConnect(); // Ensure the service proxy exists
                System.out.println("Ensure the service proxy exists End");
